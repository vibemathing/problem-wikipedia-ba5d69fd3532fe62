...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-ba5d69fd3532fe62"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-ba5d69fd3532fe62",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-ba5d69fd3532fe62",
        "url": "https://en.wikipedia.org/wiki/Oberwolfach_problem"
      }
    ],
    "statement": {
      "language": "en",
      "text": "The Oberwolfach problem on which 2-regular graphs have the property that a complete graph on the same number of vertices can be decomposed into edge-disjoint copies of the given graph.",
      "version": 1
    },
    "title": "Oberwolfach problem",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "a7a29083e25629eb3c7f240001be2e56dd144a40bf4c8d3069acc147ea59efcc"
}
```
